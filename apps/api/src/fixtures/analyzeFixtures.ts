...
const fixtures = {
    ...
    actionCards: [
      {
        ...
        editableFields: ["title", "startAt", "endAt"],
        riskFlags: [],
        memoryProposals: [
          {
  ...
  "self-meeting": {
    thread: {
      ...
      evidence: [
        {
          id: "evidence-self-name",
          quote: "我叫 Kai，请把我也加到会议参与者里。",
          speaker: "User",
        },
        {
          id: "evidence-hr-interview",
          quote: "Lina：明天下午 2 点进行 45 分钟面试。",
          speaker: "Lina HR",
        },
      ],
      uncertainties: [],
    ...
    actionCards: [
      {
        id: "action-create-hr-interview",
        type: "create_meeting",
        title: "创建 HR 面试",
        confidence: 0.94,
        evidenceRefs: ["evidence-self-name", "evidence-hr-interview"],
        editableFields: ["title", "startAt", "endAt", "participantNames"],
        riskFlags: [],
        memoryProposals: [],
        payload: {
          title: "与 Lina HR 的面试",
          startAt: "2026-08-27T06:00:00.000Z",
          endAt: "2026-08-27T06:45:00.000Z",
          timezone: "Asia/Shanghai",
          participantContactIds: [],
      ...
      },
      {
        ...
        payload: {
          ...
          emails: [],
          isSelf: true,
          interactionSummary: "用户要求将自己加入面试参与者。",
        },
      },
      {
        id: "action-create-lina-hr",
        type: "create_contact",
        title: "创建联系人 Lina HR",
        confidence: 0.94,
        evidenceRefs: ["evidence-hr-interview"],
        editableFields: ["displayName", "jobTitle"],
        riskFlags: [],
        memoryProposals: [],
        payload: {
          displayName: "Lina HR",
          ...
          emails: [],
          isSelf: false,
          interactionSummary: "Lina HR 与用户确认了面试安排。",
        },
      },
    ],
  },
